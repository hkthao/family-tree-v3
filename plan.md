...
| Phase 3 | 🚧 Đang làm | Milestone A (lunar converter + hiển thị) ✅. Milestone B (Events page list view + custom event CRUD + Dashboard panel) ✅. Milestone C (Subscribe UI: theo dõi clan-scope/person-scope, channels/lead-days/event-types editor) ✅. Còn lại: Milestone D (cron + email Resend), kinship UI, GEDCOM, OCR. |
